...
var selectItemsTitles = document.querySelectorAll('.select__title');
var selectItemsLabels = document.querySelectorAll('.select__label'); // Toggle menu

var _loop = function _loop(i) {
  var selectItemsTitle = selectItemsTitles[i];
  selectItemsTitle.addEventListener('click', function () {
    var selectContent = selectItemsTitle.nextElementSibling;

    _slideToggle(selectContent);
  });
};

for (var i = 0; i < selectItemsTitles.length; i++) {
  _loop(i);
} // slider ===========================================================
